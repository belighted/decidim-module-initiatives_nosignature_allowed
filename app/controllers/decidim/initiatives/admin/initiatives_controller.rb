    ...
    module Admin
      ...
      class InitiativesController < Decidim::Initiatives::Admin::ApplicationController
        ...
        def publish
          ...
          Decidim::Initiatives::Admin::PublishInitiative.call(current_initiative, current_user) do
            on(:ok) do
        ...
        def unpublish
          ...
          Decidim::Initiatives::Admin::UnpublishInitiative.call(current_initiative, current_user) do
            on(:ok) do
              redirect_to decidim_admin_initiatives.edit_initiative_path(current_initiative)
            end
          end
