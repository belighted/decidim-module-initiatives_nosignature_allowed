...
require "decidim/initiatives_nosignature_allowed/version"
...
Gem::Specification.new do |s|
  ...
  s.license = "AGPL-3.0"
  s.homepage = "https://github.com/decidim/decidim-module-initiatives_nosignature_allowed"
  s.required_ruby_version = ">= 2.5"

  s.name = "decidim-initiatives_nosignature_allowed"
  s.summary = "A decidim initiatives_nosignature_allowed module"
